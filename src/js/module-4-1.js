...
// console.log(user[myPropsKey]);
// user.age;

// user.age = 30;
// user.age += 10;

// user.lastname = 'prokopenko';
...
// function foo4(name, age, address) {
